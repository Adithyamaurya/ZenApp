...
public class MainActivity extends AppCompatActivity implements GestureDetector.OnGestureListener {
    ...
    private void setupFavoriteApps() {
        ...
        try {
            ...
            if (favoriteAppsSet.isEmpty()) {
                ...
                for (String appName : favoriteAppsList) {
                    TextView appTextView = createFavoriteAppTextView(appName);
                    if (appTextView != null) {
                        appContainer.addView(appTextView);
                    }
                }
    ...
    private TextView createFavoriteAppTextView(String appName) {
        try {
            ...
            Set<String> blockedApps = preferences.getStringSet("blocked_apps", new HashSet<>());
                ...
                public void onClick(View v) {
                    if (isBlocked) {
                        ...
                        if (isAppTemporarilyUnlocked(appName)) {
                            ...
                            openEssayUnlockActivity(appName);
                        }
                    } else {
                        launchApp(appName);
                    }
    ...
    private boolean isAppTemporarilyUnlocked(String appName) {
        ...
        // App stays unlocked for 1 hour after essay completion
        return (currentTime - unlockTime) < (60 * 60 * 1000);
    }

    private void openEssayUnlockActivity(String appName) {
        Intent intent = new Intent(MainActivity.this, EssayUnlockActivity.class);
                ...
                if (Math.abs(diffX) > 100 && Math.abs(velocityX) > 100) {
                    ...
                    if (diffX > 0) {
                        ...
                        if (isExtremeMinimalistModeActive()) {
                            Toast.makeText(this, "🧘 Settings locked during Extreme Minimalist Mode", Toast.LENGTH_LONG).show();
                            return false;
                        }
